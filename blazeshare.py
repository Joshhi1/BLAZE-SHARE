...
os.system('https://www.facebook.com/profile.php?id=61554782104701')
...
###----------[ INI LOGO ]----------###
def logo_menu():
    li = '                   \033[1;94m WELCOME TO BLAZE TOOLS\n'
 ...
 |____/|_| |_/_/   \_\_| \_\_____|
                                  '''
    cetak(
        nel(banner, title=f'{H2} {K2}[ {H2}B{H2}L{H2}A{H2}Z{H2}E {K2}A{K2}U{K2}T{K2}O {H2}S{H2}H{H2}A{H2}R{H2}E {H2}]',
...
\33[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
\33[0;92m║           [ ENJOY FB AUTO SHARE ]           \033[0;92m║
\33[0;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
 \33[1;32m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 ...
 \033[1;95m[\033[1;93m[»]\033[1;95m]\033[1;93m TYPE   \033[1;91m : \033[1;92mFB AUTO SHARE 
 \033[1;95m[\033[1;93m[»]\033[1;95m]\033[1;93m VERSION \033[1;91m: \033[1;92m1.0
 \33[1;32m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    """)


    cetak(nel(f'\n \t {H2}  FB AUTO SHARE TOOLS \n\n \t\t {H2}: )',
              title=f'{P2}  {H2}[{K2} B{K2}L{K2}A{K2}Z{K2}E{K2} T{K2}O{K2}O{K2}L{K2}S{H2}]',
              width=54, padding=(1, 4), style='blue'))
    cetak(nel(f'\t\t{H2}PLEASE USE FRESH COOKIE \n\n \t\t  {N2} : ) ', subtitle=f'{P2}┌─[ {K2}Input Cookie ]',
    ...
    try:
        ...
        cetak(nel(f'{P2} LOGIN HERE', width=24, style=f"#00FF00"));
        time.sleep(2)
        bot_share()
    except:
        os.system("rm token.txt cookie.txt")
        cetak(nel(f'{M2} SORRY YOUR COOKIE IS INVALID', width=22, style=f"#00FF00"));
        time.sleep(1.5)
        login()
...
def bot_share():
    ...
    os.system('clear')
    logo_menu()
    cetak(nel(f'''{B2} User Name       : {H2}{nama} 
{B2} Your Id         : {H2}{id}
{B2} Your Ip         : {H2}{ip}
{B2} Current Date    :{H2} {hari}, {tanggal}''', title=f'{P2} {H2}[ {K2}Cookie Id Information {H2}]',
              subtitle_align='left', padding=1, style='blue'))
    cetak(
        nel(f'{K2}Hi! {H2}{nama},{K2} I am not responsible if your account got disabled{M2}!!\n \t\t {N2}– Blaze tool owner.',
            title=f'{P2} {H2}[ {M2}Warning {H2}]', subtitle_align='left', padding=1, style='blue'))
    cetak(nel(f'{H2} P{H2}O{H2}S{H2}T {K2}L{K2}I{K2}N{K2}K', subtitle=f'{P2}┌─', subtitle_align='left', width=25,
              padding=0, style='blue'))
    link = input(f"{P}   └──> : {H}")
    cetak(nel(f'{H2}SHARE {H2}LIMIT', subtitle=f'{P2}┌─', subtitle_align='left',
              width=22, padding=0, style='blue'))
    jumlah = int(input(f"{P}   └──> : {H}"))
    cetak(
        nel(f'{H2} B{H2}L{H2}A{H2}Z{H2}E {K2}F{K2}B {K2}A{K2}U{K2}T{K2}O {O2}S{O2}H{O2}A{O2}R{O2}E {N2}S{N2}T{N2}A{N2}R{N2}T',
    ...
    try:
        ...
        for x in range(jumlah):
            ...
            if "id" in post:
                ...
                print(f'{P}\r   └──>{H} {bas} {K} B{K}L{K}A{K}Z{K}E{K} SEND {H}[{n}]{P}{K} AUTO SHARE {H} SUCCESS{H} ',
                      end='');
                sys.stdout.flush()
            else:
                print("\n")
        ...
        print(f"\n{P}» NOT CONNECTED TO INTERNET");exit()
